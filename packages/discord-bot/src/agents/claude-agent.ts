/**
 * AI Agent Spawner
 * Uses Z.ai API for fast, intelligent responses
 * Default model: GLM-4.7 for SOTA coding performance
 */

import { EventEmitter } from "events";

/** Request body for Anthropic-compatible APIs (Z.ai) */
...
/** Request body for OpenAI-compatible APIs (OpenRouter) */
...
// Default to GLM-4.7 for best coding performance
...
export class ClaudeAgent extends EventEmitter {
	...
	async run(options: AgentOptions): Promise<AgentResult> {
		...
		let body: AnthropicRequestBody | OpenAIRequestBody;
 ...
 * All use GLM-4.7 by default for SOTA coding performance
 */
