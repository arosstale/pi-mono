...
- Memory and CPU profiling insights`,
	...
	marketing_agency: {
		name: "Marketing Agency Expert",
		description: "Marketing strategy, campaigns, brand development, content marketing, SEO, paid ads, analytics",
		riskLevel: "medium",
		selfImprovePrompt: `After this marketing task, document learnings:

## Marketing Learnings
1. **Campaign Effectiveness**: What strategies drove results?
2. **Channel Performance**: Which channels performed best?
3. **Content Insights**: What content resonated with audiences?
4. **ROI Analysis**: What was the return on investment?
5. **Audience Insights**: What did we learn about target audiences?

## Optimization Patterns
- Effective campaign structures, targeting, creative approaches

## Anti-Patterns
- Vanity metrics, poor attribution, scattered messaging`,
		mentalModel: `A Marketing Expert accumulates knowledge about:
- Campaign optimization and channel mix strategies
- Content marketing best practices
- SEO and paid advertising patterns
...
- Brand positioning and messaging`,
	...
	smma: {
		name: "SMMA Expert",
		description:
			"Social media marketing, content creation, influencer marketing, community building, viral strategies",
		riskLevel: "medium",
		selfImprovePrompt: `After this SMMA task, document learnings:

## SMMA Learnings
1. **Platform Performance**: Which platforms drove engagement?
2. **Content Strategy**: What content types performed best?
3. **Growth Tactics**: What tactics increased followers/engagement?
4. **Client Acquisition**: What outreach methods worked?
5. **Service Delivery**: What streamlined operations?

## Optimization Patterns
- Hook frameworks, viral mechanics, batch production

## Anti-Patterns
- Inconsistent posting, poor engagement, over-promising`,
		mentalModel: `An SMMA Expert accumulates knowledge about:
- Platform-specific algorithms and best practices
- Content creation and repurposing strategies
- Growth hacking and engagement tactics
...
- Agency operations and scaling`,
	...
	sales: {
		name: "Sales Expert",
		description: "Sales strategy, cold outreach, closing deals, objection handling, sales scripts, CRM",
		riskLevel: "medium",
		selfImprovePrompt: `After this sales task, document learnings:

## Sales Learnings
1. **Objections Encountered**: What objections came up and how handled?
2. **Closing Techniques**: What closing approaches worked?
3. **Discovery Insights**: What questions uncovered real pain?
4. **Pipeline Patterns**: What moved deals forward?
5. **Messaging Effectiveness**: What value props resonated?

## Optimization Patterns
- Effective scripts, email sequences, follow-up cadences

## Anti-Patterns
- Pitching too early, poor qualification, ghosting follow-ups`,
		mentalModel: `A Sales Expert accumulates knowledge about:
- SPIN, Challenger, MEDDIC, Sandler methodologies
- Objection handling and closing techniques
- Cold outreach and warm nurturing sequences
- Discovery call frameworks
- Deal qualification and pipeline management`,
	},

	fullstack_dev: {
		name: "Fullstack Developer Expert",
		description: "Web development, APIs, databases, frontend, backend, DevOps, production applications",
		riskLevel: "high",
		selfImprovePrompt: `After this development task, document learnings:

## Development Learnings
1. **Architecture Decisions**: What patterns were effective?
2. **Tech Stack Insights**: What tools/libraries worked well?
3. **Performance Considerations**: What optimizations were applied?
4. **Code Quality**: What practices improved maintainability?
5. **Deployment Issues**: What deployment challenges emerged?

## Optimization Patterns
- Effective architectures, testing strategies, CI/CD patterns

## Anti-Patterns
- Over-engineering, poor error handling, tech debt accumulation`,
		mentalModel: `A Fullstack Developer Expert accumulates knowledge about:
- Frontend frameworks (React, Vue, Next.js) patterns
- Backend architectures (Node, Python, Go)
...
- DevOps and deployment strategies`,
	...
	designer: {
		...
		description: "UI/UX design, design systems, user interfaces, branding, prototypes, visual design",
		riskLevel: "medium",
		selfImprovePrompt: `After this design task, document learnings:

## Design Learnings
1. **User Experience**: What improved user flow and usability?
2. **Visual Hierarchy**: What layout patterns were effective?
3. **Design System**: What components/tokens were established?
4. **Accessibility**: What a11y considerations were addressed?
5. **Responsive Design**: What breakpoint strategies worked?

## Optimization Patterns
- Effective component patterns, spacing systems, color usage

## Anti-Patterns
- Inconsistent spacing, poor contrast, over-complicated layouts`,
		mentalModel: `A Designer Expert accumulates knowledge about:
- UI design patterns and visual hierarchy
- UX research and user journey mapping
- Design system architecture (tokens, atoms, molecules)
...
- Responsive and adaptive design strategies`,
	...
	game_dev: {
		...
		description:
			"Game development, game engines, Unity, Unreal, Godot, graphics programming, physics, AI, multiplayer",
		riskLevel: "high",
		selfImprovePrompt: `After this game dev task, document learnings:

## Game Dev Learnings
1. **Architecture**: What game systems/patterns were effective?
2. **Performance**: What optimizations improved frame rate?
3. **Engine-Specific**: What engine quirks or best practices emerged?
4. **Gameplay**: What made the mechanics feel good?
5. **Technical Challenges**: What complex problems were solved?

## Optimization Patterns
- Effective pooling, batching, LOD, memory strategies

## Anti-Patterns
- Update() abuse, GC spikes, physics in wrong thread, tight coupling`,
		mentalModel: `A Game Developer Expert accumulates knowledge about:
- Game engine patterns (Unity, Unreal, Godot)
- Graphics programming and shader development
- Physics and collision systems
- AI (pathfinding, behavior trees, GOAP)
...
// ============================================================================
// PERFORMANCE: Domain keywords at module level (avoid recreation per call)
